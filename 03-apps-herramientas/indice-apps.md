...
|-------------|-------------|-------------|
| **Storm Sequencer v3.0** | Secuenciador musical online para componer ejercicios y exportarlos como MIDI | Integrado en la plataforma; los archivos MIDI se envían al Maestro Virtual para validación |

---

## Apps Personales de Luis

[LLENAR — Luis tiene apps propias para tracking de entrenamientos físicos, finanzas del hogar, y apps para familiares. Documentar en `otras-apps.md`.]
