...
Este indice registra la cartera y los aprendizajes transversales. No replica la documentacion tecnica que ya vive en el repo de cada empresa.

## Pendientes

- Registrar el nombre o URL de cada repo cuando Luis decida incluirlo.
- Distinguir clientes, proyectos internos, prospectos y proyectos terminados.
- Registrar que proyectos ya producen ingresos sin guardar datos financieros sensibles por defecto.
